...
sys.path.append("..")
from spider_ly.items import SpiderCommentItem
...
class CrawlCommentSpider(RedisSpider):
    ...
    # start_urls = ['https://www.ly.com/scenery/AjaxHelper/DianPingAjax.aspx?action=GetDianPingList&sid=111&page=1&pageSize=10&labId=1&sort=0&iid=0.3952226431943444']
    ...
    #     url = 'https://www.ly.com/scenery/AjaxHelper/DianPingAjax.aspx?action=GetDianPingList&sid=580495&page=1&pageSize=10&labId=1&sort=0&iid=0.3952226431943444'
    #     maps = lambda x: x[0] if x else ''
    #     sid = int(maps(re.findall('sid=(\d+)&', url)))
    #     yield Request(url,
    #                   callback=self.parse,
    ...
    def parse(self, response):
        ...
        for dp in dpLists:
            ...
            # 处理翻页
        page += 1
        if page <= totalPage and page < 100:
            params = {
