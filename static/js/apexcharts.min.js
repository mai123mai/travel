            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return e.config.yaxis.map((function (r, n) {
                    ...
                    if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                        var l = e.globals.yLabelFormatters[n], h = o.niceMin === Number.MIN_VALUE ? 0 : o.niceMin,
                            c = String(h).length > String(o.niceMax).length ? h : o.niceMax,
                            d = l(c, {seriesIndex: n, dataPointIndex: -1, w: e}), g = d;
                        ...
                        var p = new b(t.dCtx.ctx), x = "rotate(".concat(r.labels.rotate, " 0 0)"),
                            m = p.getTextRects(d, r.labels.style.fontSize, r.labels.style.fontFamily, x, !1), v = m;
        ...
        return a(t, [{
            key: "calculateTimeScaleTicks", value: function (t, e) {
                ...
                var o = s.getTimeUnitsfromTimestamp(t, e, this.utc), l = a.globals.gridWidth / r, h = l / 24,
                    c = h / 60, d = c / 60, g = Math.floor(24 * r), u = Math.floor(1440 * r), f = Math.floor(r * Mt),
