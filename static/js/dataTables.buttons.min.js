...
!function (e) {
    ...
    "use strict";
    var e = v.fn.dataTable, o = 0, C = 0, w = e.ext.buttons;
    ...
    v.extend(k.prototype, {
        action: function (t, n) {
            ...
            var a = this.s.dt, l = !1, u = Array.isArray(n) ? n : [n];
            ...
            var s, r, a, l, u = this.c.dom.button, c = this.c.dom.buttonLiner, d = this.c.dom.collection,
            ...
            var s, r, a, l, u, c, d, f = t, p = this.c, h = !1, b = v.extend({
                align: "button-left",
                autoClose: !1,
                background: !0,
        ...
        for (var u = [], c = function (t, n, e) {
            ...
            var e = [], o = (c(e, n.s.buttons), v.map(e, function (t) {
                return t.node
            }));
            if (Array.isArray(t) || t instanceof v) for (s = 0, r = t.length; s < r; s++) d(t[s], n); else if (null === t || t === x || "*" === t) for (s = 0, r = e.length; s < r; s++) u.push({
                inst: n,
                node: e[s].node
        ...
        collection: {
            ...
            }, className: "buttons-collection", closeButton: !(k.version = "2.3.3"), init: function (t, n, e) {
    ...
    var i, n = function (t) {
        ...
        }).toArray() : null, i = v.extend({}, o.modifier), i = (e.select && "function" == typeof e.select.info && i.selected === x && e.rows(o.rows, v.extend({selected: !0}, i)).any() && v.extend(i, {selected: !0}), e.rows(o.rows, i).indexes().toArray()), i = e.cells(i, o.columns), s = i.render(o.orthogonal).toArray(), r = i.nodes().toArray(), a = t.length, l = [], u = 0, c = 0, d = 0 < a ? s.length / a : 0; c < d; c++) {
