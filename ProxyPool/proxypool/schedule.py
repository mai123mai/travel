...
class PoolAdder(object):
    ...
    def __init__(self, threshold):
        self._threshold = threshold        # 代理池最大值
        self._conn = RedisClient()         # redis接口
        self._tester = ValidityTester()    # 验证接口
        self._crawler = FreeProxyGetter()  # 爬虫接口
    ...
    def add_to_queue(self):
        ...
        proxy_count = 0
        while not self.is_over_threshold():         # 判断是否溢出
...
class Schedule(object):
    ...
    def check_pool(lower_threshold=POOL_LOWER_THRESHOLD,
        ...
        lower_threshold：代理池的下限
        upper_threshold：代理池的上限
        cycle：检查周期
        """
        conn = RedisClient()
